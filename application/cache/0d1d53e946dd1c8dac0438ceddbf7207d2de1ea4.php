        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="input-group date" id="start-datepicker">
                    <input type="text" class="form-control" value="<?php echo e(date('d-m-Y')); ?>">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pramuka/application/views/backend/summary/periode.blade.php ENDPATH**/ ?>