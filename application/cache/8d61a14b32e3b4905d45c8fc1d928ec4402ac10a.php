<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="all-tab">
    <div class="adv-table">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="<?php echo e(base_url('assets/backend/img/bug.svg')); ?>" alt="">
            </div>
            <div class="col-md-8">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pramuka/application/views/backend/helpdesk/contact.blade.php ENDPATH**/ ?>