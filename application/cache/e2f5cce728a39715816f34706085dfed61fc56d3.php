    ...
    <div class="footerbottom">
        ...
        <div class="row">
            ...
            <div class="medium-6 small-12 columns">
                <div class="copyrightinfo">2016 &copy; <a href="index.html#">Webful Creations Vision</a> All Rights Reserved.</div>
            </div><!-- left side /-->
            <div class="medium-6 small-12 columns hide-for-small-only">
                <div class="pull-right">
                    <ul class="menu">
                        ...
                        <li><a href="https://www.webfulcreations.com/envato/webful_education/services.html">Services</a></li>
                        <li><a href="https://www.webfulcreations.com/envato/webful_education/contact.html">Contact Us</a></li>
                    </ul>
                </div>
            </div><!-- Right Side /-->
