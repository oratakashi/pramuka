...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-2"><?php echo e("Tambah Pengguna"); ?> <a href="<?php echo e(base_url('admin/user.html')); ?>"><button class="btn btn-sm btn-danger">Batal</button></a></h4>
                    <form action="<?php echo e(base_url('admin/user/create.aspx')); ?>" method="post" enctype="multipart/form-data" style="margin-top:30px">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="">
                                    <center>
                                    <a class="user-avatar" href="#">
                                        <img id="photo" class="thumb-md mb-2 rounded-circle" src="<?php echo e(base_url('media/photo_user/no-pict.png')); ?>" style="width:150px;height:150px" alt="">
                                    </a>
                                    </center>
                                    ...
                                    <div class="col-md-8" id="parent_kecamatan">
                                        ...
                                        <select name="kecataman" id="kecamatan" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $data_kec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($data['id_kecamatan']); ?>"><?php echo e($data['nama_kecamatan']); ?></option>
