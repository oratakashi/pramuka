              ...
              <ul class="nav top-menu">
                  ...
                  <li id="header_notification_bar" class="dropdown">
                      ...
                      <ul class="dropdown-menu extended notification">
                          ...
                          <li>
                              <a href="#">
                                  <span class="badge badge-danger"><i class="fa fa-bolt"></i></span>
                                  Server #3 overloaded.
                          ...
                          <li>
                              <a href="#">
                                  <span class="badge badge-warning"><i class="fa fa-bell"></i></span>
                          ...
                          <li>
                              <a href="#">
                                  <span class="badge badge-info"><i class="fa fa-bullhorn"></i></span>
                                  Application error.
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/pramuka/application/views/backend/master.blade.php ENDPATH**/ ?>