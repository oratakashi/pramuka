        ...
        <div class="medium-12 small-12 columns">
            ...
            <div class="medium-7 small-12 columns product-detail">
                ...
                <div class="add-cart-option">
                    <a href="https://api.whatsapp.com/send?phone=6282301117118&text={{$endcoded}}" class="button primary" target="_blank">Beli Sekarang</a> 
                </div><!-- add cart option -->
                ...
                <div class="single-product">
                    <div class="product-img thumbnail">
                        ...
                        <div class="add-to-cart-top">
                                <a href="https://api.whatsapp.com/send?phone=6282301117118&text={{$endcoded}}" class="button primary">Beli Sekarang</a>
                        </div>
                    </div>
