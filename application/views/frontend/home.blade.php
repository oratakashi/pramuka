...
@section('title', 'Home - Pramuka Lumajang')
        ...
        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" data-version="5.0.7">
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-16" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off">
                    <!-- MAIN IMAGE -->
                    <img src="{{base_url('assets/frontend/')}}images/help/slide1.jpg"  alt="First Slide"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" />
                    <!-- LAYERS -->
                ...
                <li data-index="rs-17" data-transition="fadetotopfadefrombottom" data-slotamount="default"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500" data-rotate="0"  data-saveperformance="off">
                    <!-- MAIN IMAGE -->
                    <img src="{{base_url('assets/frontend/')}}images/help/slide2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                ...
                <li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-saveperformance="off">
                    <!-- MAIN IMAGE -->
                    <img src="{{base_url('assets/frontend/')}}images/help/slide3.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
...
<div class="welcome-message module">
    <div class="row">
        ...
        <div class="medium-6 small-12 columns">
            <img src="{{base_url('assets/frontend/')}}images/help/education_bg.jpg" alt="Education Background" />
        </div><!-- Left Column /-->
            ...
            <div class="tabs-content" data-tabs-content="course-tabs">
                ...
                <div class="tabs-panel is-active" id="graphic_design">
                    ...
                    <div class="medium-4 small-12 columns">
                        <div class="course">
                            <div class="course-thumb">
                                <img src="{{base_url('assets/frontend/')}}images/help/print.jpg" alt="Graphic Design" />
                                <img src="{{base_url('assets/frontend/')}}images/help/teacher3.jpg" class="teacher" alt="Michel" />
                    ...
                    <div class="medium-4 small-12 columns">
                        <div class="course">
                            <div class="course-thumb">
                                <img src="{{base_url('assets/frontend/')}}images/help/web.jpg" alt="Graphic Design" />
                                <img src="{{base_url('assets/frontend/')}}images/help/teacher2.jpg" class="teacher" alt="Michel" />
                                <div class="teacher-name">John Doe.</div>
                                <div class="price-tag">$28.55</div>
                            </div>
                            <h3>Web Designing</h3>
                    ...
                    <div class="medium-4 small-12 columns">
                        <div class="course">
                            <div class="course-thumb">
                                <img src="{{base_url('assets/frontend/')}}images/help/logo.jpg" alt="Graphic Design" />
                                <img src="{{base_url('assets/frontend/')}}images/help/teacher1.jpg" class="teacher" alt="Michel" />
                                <div class="teacher-name">John Doe.</div>
                                <div class="price-tag">$28.55</div>
                            </div>
        ...
        <div class="events-wrapper">
            ...
            <div class="medium-6 small-12 columns">
                <div class="event">
                    ...
                    <div class="medium-4 small-12 columns event-thumb">
                        <img src="{{base_url('assets/frontend/')}}images/help/phpcourse.jpg" alt="PHP Course" />
                    </div><!-- Event thumb /-->    	
                    <div class="clearfix"></div>
                </div><!-- Event div ends /-->
            ...
            <div class="medium-6 small-12 columns">
                <div class="event">
                    ...
                    <div class="medium-4 small-12 columns event-thumb">
                        <img src="{{base_url('assets/frontend/')}}images/help/graphiccourse.jpg" alt="PHP Course" />
                    </div><!-- Event thumb /-->    	
                    <div class="clearfix"></div>
                </div><!-- Event div ends /-->
            </div><!-- Event Column Ends /-->
...
<div class="gallery-wrapper module">
    ...
    <div class="gallery-container">
        ...
        <a href="images/help/gallery1.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery1.jpg" alt=""/>
        </a>
        <a href="images/help/gallery2.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery2.jpg" alt=""/>
        </a>
        <a href="images/help/gallery3.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery3.jpg" alt=""/>
        </a>
        <a href="images/help/gallery4.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery4.jpg" alt=""/>
        </a>
        <a href="images/help/gallery5.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery5.jpg" alt=""/>
        </a>
        <a href="images/help/gallery6.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery6.jpg" alt=""/>
        </a>
        <a href="images/help/gallery7.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery7.jpg" alt=""/>
        </a>
        <a href="images/help/gallery8.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery8.jpg" alt=""/>
        </a>
        <a href="images/help/gallery9.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery9.jpg" alt=""/>
        </a>
        <a href="images/help/gallery10.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery10.jpg" alt=""/>
        </a>
        <a href="images/help/gallery11.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery11.jpg" alt=""/>
        </a>
        <a href="images/help/gallery12.jpg" data-lightbox="campus-gallery" data-title="Great Life in our Campus. Some great moments of life.">
            <img class="gallery-thumb" src="{{base_url('assets/frontend/')}}images/help/gallery12.jpg" alt=""/>
        </a>
...
<div class="seminar-events content-area module">
    <img src="{{base_url('assets/frontend/')}}images/help/businesswoman.png" class="upper-background" alt="Business Women" />
    <div class="row">
        ...
        <div class="testimonials">
            ...
            <div class="testimonial">
                <div class="testimonial-thumb">
                    <img src="{{base_url('assets/frontend/')}}images/help/first_testimonial.jpg" alt="John Doe" />
            ...
            <div class="testimonial">
                <div class="testimonial-thumb">
                    <img src="{{base_url('assets/frontend/')}}images/help/first_testimonial2.jpg" alt="John Doe" />
                </div><!-- Testimonial Thumb /-->
                <div class="testimonial-detail">
                    <h4>Very happy to find this institute!</h4>
                    <p>After graduation we were very worried about our children what he will do as he does not have any work experience but when he joined this abc institute this he became so professional!</p>
...
<div class="brands-wrap side-controls module">
    ...
    <div class="row">
        ...
        <div class="brand-carousel">
            ...
            <div class="bran-logo"><a href="index.html#"><img  alt="" src="{{base_url('assets/frontend/')}}images/help/partner1.jpg" class="thumbnail" /></a></div>
            <div class="bran-logo"><a href="index.html#"><img  alt="" src="{{base_url('assets/frontend/')}}images/help/partner2.jpg" class="thumbnail" /></a></div>
            <div class="bran-logo"><a href="index.html#"><img  alt="" src="{{base_url('assets/frontend/')}}images/help/partner3.jpg" class="thumbnail" /></a></div>
            <div class="bran-logo"><a href="index.html#"><img  alt="" src="{{base_url('assets/frontend/')}}images/help/partner4.jpg" class="thumbnail" /></a></div>
            <div class="bran-logo"><a href="index.html#"><img  alt="" src="{{base_url('assets/frontend/')}}images/help/partner5.jpg" class="thumbnail" /></a></div>
            <div class="bran-logo"><a href="index.html#"><img  alt="" src="{{base_url('assets/frontend/')}}images/help/partner6.jpg" class="thumbnail" /></a></div>
