...
@section('title', 'Ubah Pengurus - Pramuka Lumajang')
            ...
            <div class="col-sm-12">
                <section class="card">
                    <header class="card-header">
                        {{ "Ubah Pengurus" }} <a href="{{ base_url('admin/pengurus.html') }}"><button class="btn btn-sm btn-danger">Batal</button></a>
                            <span class="tools pull-right">
                                <a href="javascript:;" class="fa fa-chevron-down"></a>
                            </span>
                    </header>
                    <form action="{{ base_url('admin/pengurus/').$pengurus['id_pengurus'] }}/update.aspx" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row">
                                    <aside class="profile-nav col-lg-3">
                                        <section class="card">
                                            <div class="user-heading round">
                                                <a href="#">
                                                    <img id="photo" src="{{base_url('media/pengurus/').$pengurus['photo']}}" alt="">
                                                </a>
