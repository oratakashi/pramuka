                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <?php if($artikel['status'] == 1){ ?>
                                                            ...
                                                            <a href="{{ base_url('pengurus/article/').$artikel['id_artikel'] }}/deactivated.aspx"><button type="button" class="btn btn-sm btn-danger">Nonaktifkan</button></a>
                                                        <?php } else if($artikel['status'] == 0) {?>
                                                            <a href="{{ base_url('pengurus/article/').$artikel['id_artikel'] }}/activated.aspx"><button type="button" class="btn btn-sm btn-success">Aktifkan</button></a>
                                                        <?php } ?>
                                                        <?php if($artikel['status'] == 1){ ?>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ base_url('pengurus/article/').$artikel['id_artikel'] }}.html">Ubah</a>
