                    ...
                    <div class="col-sm-12">
                        <section class="card">
                            <header class="card-header">
                                {{ "Ubah Produk" }} <a href="{{ base_url('admin/products.html') }}"><button class="btn btn-sm btn-danger">Batal</button></a>
                                    <span class="tools pull-right">
                                        <a href="javascript:;" class="fa fa-chevron-down"></a>
                                    </span>
                            </header>
                            <form action="{{ base_url('admin/products/').$data['id_product'] }}/update.aspx" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="row">
                                        <aside class="profile-nav col-lg-3">
                                            <section class="card">
                                                <div class="">
                                                    <center><a href="#">
                                                        <img id="photo" src="{{base_url('media/product/').$data['foto']}}" alt="" style="width:250px;height:250px">
                                                    </a></center>
